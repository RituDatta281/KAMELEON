...
from kg_construct.unsloth_LLM import get_embedding
import pickle
...
DATASET = 'mimic3'
# File paths
PATIENT_CONTEXT_PATH = f"patient_context/base_context/patient_contexts_{DATASET}_{TASK}_notes.json"
PATIENT_EMBEDDINGS_PATH = f"patient_context/base_context/patient_embeddings_{DATASET}_{TASK}_notes.pkl"
