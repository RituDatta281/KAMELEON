...
def combine_knowledge_graphs(graph_path: str, extracted_kg_path: str) -> None:
    ...
    kg_from_llm = json.load(open(os.path.join(extracted_kg_path, "graph_PPID/kg_from_llm.json"), "r"))
    ...
    # kg_from_pubmed.json
    # kg_from_pubmed = json.load(open(os.path.join(extracted_kg_path, "graph_PPID/kg_from_PPID.json"), "r"))
    kg_from_pubmed = json.load(open(os.path.join(extracted_kg_path, "kg_from_pubmed_DN.json"), "r")) 
    ...
    with open(os.path.join(graph_path, "kg_raw_pubmed.txt"), "w") as f:
        f.write(all_triples)
...
def main():
    graph_path = "./graph_PPID"
    extracted_kg_path = "/kg_construct/"
